...
webbrowser.open('https://t.me/Busetermux')
...
file.write(' Telegram : @Buseben Proxyleriniz:\n')
file.close()
...
input(f' \n\n[Buseben] Toplam Bulunan Proxyler : ({len(good_proxies)}) Adet proxy.txt Dosyasına Kayıt Edilldi. ')
